...
def index():
    ...
    <body onclick="ativarAlertas()">
        ...
        <div class="card">
            ...
            <div id="status" class="footer">INICIANDO GPS...</div>
        </div>
        ...
        <script>
            ...
            window.onload = function() {
                navigator.geolocation.getCurrentPosition(pos => {
                    ...
                    document.getElementById('status').innerText = "VIGIANDO GPS LOCAL";
                    iniciarRadar();
                }, () => {
                    document.getElementById('status').innerText = "USE A BARRA DE BUSCA:";
            ...
            function executarBusca() {
                ...
                .then(res => res.json()).then(data => {
                    if(data.found) {
                        ...
                        document.getElementById('status').innerText = "ÚLTIMA BUSCA: " + new Date().toLocaleTimeString();
                    }
                });
            }
        </script>
