...
# Configurações V102 - Acumulativa e Estável
RADIUS_KM = 200 
DEFAULT_LAT = -22.9068
DEFAULT_LON = -43.1729
                ...
                if slat and slon:
                    ...
                    if d <= RADIUS_KM:
                        ...
                        proc.append({
                            ...
                            "date": now_date, "time": now_time, "route": s.get('route', "--- ---"), "eta": eta
                        })
...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; }
        ...
        .ticker { width: 310px; height: 35px; background: #000; border-radius: 6px; margin-top: 15px; display: flex; align-items: center; justify-content: center; color: var(--gold); font-family: monospace; font-size: 11px; letter-spacing: 1px; white-space: pre; border: 1px solid #333; }

        /* LANDSCAPE FIX */
        @media (orientation: landscape) {
            .scene { width: 520px; height: 280px; }
            ...
            .perfor::before { top: -25px; left: -15px; }
            .perfor::after { bottom: -25px; top: auto; left: -15px; }
...
<body onclick="handleFlip(event)">
    ...
    <div class="scene" id="card">
        <div class="face front">
            ...
            <div class="main">
                <div style="color: #333; font-weight: 900; font-size: 12px; border: 1.5px solid #333; padding: 3px 10px; border-radius: 4px; align-self: flex-start; letter-spacing:1px;">BOARDING PASS</div>
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end;">
                    ...
                    <div class="date-visual">
                        <div id="f-line1" style="font-size:9px;">-- --- ----</div>
        ...
        <div class="face back">
            <div style="height:100%; border:1px dashed #ccc; border-radius:15px; padding:20px; display:flex; flex-direction:column; justify-content:space-between;">
                ...
                <div style="border: 3px double var(--blue-txt); color: var(--blue-txt); padding: 15px; border-radius: 10px; transform: rotate(-8deg); align-self: center; text-align: center; font-weight: 900; background: rgba(52, 168, 201, 0.05);">
                    <div style="font-size:8px; letter-spacing:2px;">SECURITY CHECKED</div>
                    <div id="b-date-line1" style="font-size:10px; margin: 3px 0;">-- --- ----</div>
                    <div id="b-date-line2" style="font-size:24px;">--.--</div>
                    <div style="font-size:8px; margin-top:5px; opacity:0.8;">RADAR CONTACT V102</div>
                </div>
                <div style="font-size:7px; text-align:center; color:#bbb; font-weight:900;">NON-TRANSFERABLE • ADSB-REALTIME</div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        // Troca de Labels a cada 20s (Mantido da V95)
        setInterval(() => {
            if(act) {
        ...
        function hideUI() { 
            ...
            setTimeout(() => { update(); setInterval(update, 20000); }, 800); 
        }
        ...
        navigator.geolocation.getCurrentPosition(p => { 
            ...
            applyFlap('tk', 'ENTER LOCATION ABOVE', true); 
        }, { timeout: 6000 });
    </script>
</body>
</html>
